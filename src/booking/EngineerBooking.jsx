...
const EngineerBooking = ({ token, userId, fetchBookings, showPopup }) => {
  ...
  const formattedProjectStartDate = projectStartDate
    ? format(projectStartDate, "EEEE, MMMM d, yyyy")
    : "";
  const formattedProjectEndDate = projectEndDate
    ? format(projectEndDate, "EEEE, MMMM d, yyyy")
    : "";
  ...
  return (
    <div className="engineeringcard">
      ...
      <form className="engineeringform-content" onSubmit={handleSubmit}>
        ...
        <button className="engineeringsubmit-button" type="submit">
          Submit Engineering Booking
        </button>
      </form>
    </div>
  );
